import { SurveyBackdrop } from "./survey-backdrop.tsx";

export default function SurveyBackdropExamples() {
  return (
    <section
      style={{
        position: "relative",
...
export const catalogueExamples = defineCatalogueExamples(
  ...
  [{ id: "default", Example: SurveyBackdropExamples }],
);
import { defineCatalogueExamples } from "../../../../catalogue/conformance.ts";
import meta, { componentExampleVocabulary } from "./survey-backdrop.meta.ts";
