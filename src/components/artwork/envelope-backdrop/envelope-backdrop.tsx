...
/** Props for the {@linkcode EnvelopeBackdrop} component. */
...
export const EnvelopeBackdrop: DiscernComponent<
  HTMLDivElement,
  EnvelopeBackdropProps
> = forwardRef<HTMLDivElement, EnvelopeBackdropProps>(function EnvelopeBackdrop(
  { className, ...props },
  ref,
) {
  return (
    <Backdrop
      ref={ref}
      className={classNames("discern-envelope-backdrop", className)}
      {...props}
    >
      <svg
        className="discern-backdrop__plate discern-envelope-backdrop__plate"
      ...
      >
        {ENVELOPE_FAMILIES.map((family, familyIndex) => (
          <g key={familyIndex}>
            <g className="discern-envelope-backdrop__leg">
            ...
            <g className="discern-envelope-backdrop__chords">
              {family.chords.map((chord, chordIndex) => (
                <line
                  key={chordIndex}
                  className="discern-envelope-backdrop__chord"
                  x1={chord.x1}
                  y1={chord.y1}
                  x2={chord.x2}
                  y2={chord.y2}
            ...
            <g className="discern-envelope-backdrop__crest">
              {family.chords.map((chord, chordIndex) => (
                <line
                  key={chordIndex}
                  style={{
