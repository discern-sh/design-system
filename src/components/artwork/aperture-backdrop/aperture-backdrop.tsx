...
/** Props for the {@linkcode ApertureBackdrop} component. */
export interface ApertureBackdropProps
  extends Omit<BackdropProps, "children"> {}

/** Off-centre triangular opening that admits three unequal beams. */
export const ApertureBackdrop: DiscernComponent<
  HTMLDivElement,
  ApertureBackdropProps
> = forwardRef<HTMLDivElement, ApertureBackdropProps>(function ApertureBackdrop(
  { className, ...props },
  ref,
) {
  ...
  return (
    <Backdrop
      ref={ref}
      className={classNames("discern-aperture-backdrop", className)}
      {...props}
    >
      <svg
        className="discern-backdrop__plate discern-aperture-backdrop__plate"
      ...
      >
        ...
        {APERTURE_BEAMS.map((beam) => (
          <g
            ...
            className={beam.accent
              ? "discern-aperture-backdrop__beam discern-aperture-backdrop__beam--accent"
              : "discern-aperture-backdrop__beam"}
            style={{
          ...
          >
            ...
            />
            <line
              className="discern-aperture-backdrop__edge"
              x1={beam.edge.x1}
              y1={beam.edge.y1}
              x2={beam.edge.x2}
              y2={beam.edge.y2}
        ...
        <path
          className="discern-aperture-backdrop__frame"
