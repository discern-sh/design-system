...
/** Props for the {@linkcode TilingGround} component. */
export interface TilingGroundProps extends Omit<GroundProps, "children"> {}
 ...
 */
export const TilingGround: DiscernComponent<
  HTMLDivElement,
  TilingGroundProps
> = forwardRef<HTMLDivElement, TilingGroundProps>(function TilingGround(
  { className, ...props },
  ref,
) {
  return (
    <Ground
      ref={ref}
      className={classNames("discern-tiling-ground", className)}
      {...props}
    >
      <svg
      ...
      >
        <g aria-hidden="true">
          <g className="discern-tiling-ground__field">
            {TILING_COLUMNS.map((path, column) => (
              <path
                key={column}
                className="discern-tiling-ground__column"
                d={path}
          ...
          {TILING_TURNERS.map((turner) => (
            <g
              ...
              className="discern-tiling-ground__tile"
              style={{
            ...
            >
              <g
                className="discern-tiling-ground__tile-arcs"
              ...
              {turner.traced.map((entry, index) => (
                <path
                  ...
                  className={entry.rest
                    ? "discern-tiling-ground__route discern-tiling-ground__route--rest"
                    : "discern-tiling-ground__route"}
                  d={entry.arc}
                  vectorEffect="non-scaling-stroke"
          ...
          <g className="discern-tiling-ground__routes">
