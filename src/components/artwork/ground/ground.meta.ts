...
export default {
  ...
  accessibility: [
    "Grounds are always hidden from assistive technology and never receive focus.",
    "Authored motion resolves to a complete still composition when reduced motion is requested.",
    "Decorative grounds disappear in forced-colour modes so they cannot obscure foreground content.",
  ],
