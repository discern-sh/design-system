...
export const compactFlowLightSvg =
  `<svg xmlns="http://www.w3.org/2000/svg" class="discern-diagram discern-diagram--standalone" viewBox="0 0 682.58 112" width="682.58" height="112" role="img" aria-label="Publish reference material: Authoring, checking, and publication progress from left to right.">
  ...
  <rect class="discern-diagram__canvas" x="0" y="0" width="682.58" height="112" />
  <g class="discern-diagram__group" data-discern-diagram-group="edge-ready-group">
    <g class="discern-diagram__relationship" data-discern-diagram-relationship="ready">
      <polyline class="discern-diagram__connector discern-diagram__connector--primary" points="193.77,56 241.77,56 279.77,56" stroke-width="2" />
      <polygon class="discern-diagram__arrowhead discern-diagram__arrowhead--primary" points="289.77,56 279.77,61 279.77,51" />
    </g>
  </g>
  <g class="discern-diagram__group" data-discern-diagram-group="edge-green-group">
    <g class="discern-diagram__relationship" data-discern-diagram-relationship="green">
      <polyline class="discern-diagram__connector discern-diagram__connector--primary" points="435.54,56 483.54,56 521.54,56" stroke-width="2" />
      <polygon class="discern-diagram__arrowhead discern-diagram__arrowhead--primary" points="531.54,56 521.54,61 521.54,51" />
    </g>
  </g>
  <g class="discern-diagram__group" data-discern-diagram-group="node-author-group">
    ...
    <text class="discern-diagram__text discern-diagram__text--node-text" data-discern-diagram-owner="author" font-size="16">
      <tspan x="40" y="62">Author source</tspan>
    </text>
  </g>
  <g class="discern-diagram__group" data-discern-diagram-group="node-check-group">
    <rect class="discern-diagram__node discern-diagram__node--ordinary" x="289.77" y="28" width="145.77" height="56" rx="8" />
    <text class="discern-diagram__text discern-diagram__text--node-text" data-discern-diagram-owner="check" font-size="16">
      <tspan x="305.77" y="62">Run checks</tspan>
    </text>
  </g>
  <g class="discern-diagram__group" data-discern-diagram-group="node-publish-group">
    <rect class="discern-diagram__node discern-diagram__node--end" x="531.54" y="24" width="127.04" height="64" rx="32" />
    <rect class="discern-diagram__node-cue discern-diagram__node--end" x="535.54" y="28" width="119.04" height="56" rx="28" />
    <text class="discern-diagram__text discern-diagram__text--node-text" data-discern-diagram-owner="publish" font-size="16">
      <tspan x="556.66" y="52">Publish</tspan>
      <tspan x="547.54" y="72">reference</tspan>
    </text>
  </g>
</svg>
`;
