  ...
  try {
    ...
    assert(
      await page.locator('#standard-true-0 [data-line="3"]').evaluate((
        ...
        getComputedStyle(element, "::after").borderInlineStartStyle ===
          "solid" &&
        parseFloat(
            getComputedStyle(element, "::after").borderInlineStartWidth,
          ) > 0
      ),
    );
    await page.emulateMedia({ forcedColors: "none" });
    await withViewport(page, { width: 320, height: 900 }, async () => {
      await page.evaluate(() => {
