...
| --- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------ |
| 1A  | [Project chroma and make appearances scopeable](1a-chromatic-field-and-scopes.md)      | One architectural agent                                                    | This planning package and monochrome-field 3A/3B are on `main` | Sole wave-1 stream                                           |
