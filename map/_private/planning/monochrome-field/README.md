...
| --- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| 0A  | [Mock the field for maintainer sign-off](0a-proof-of-concept-signoff.md)                              | One throwaway worktree                                                 | This package is on `main`                                                                                                           | Never. Its findings were copied into `_done/` by 1A and the worktree has been dropped |
...
| 4A  | [Adopt the appearance on discern.sh and the homepage](4a-site-adoption-and-homepage.md)               | One agent in the discern repository                                    | A release containing 3A, 3B, the completed field-appearance programme, and the appearance model of ADR 0045 is published and pinned | In the sibling repository under its own gate                                          |
...
That topology describes this programme itself. The four intervening field-appearance sessions and the appearance-model session of ADR 0045 were dispatched and landed separately; every stream but 4A has landed, and 4A waits only on the release.
