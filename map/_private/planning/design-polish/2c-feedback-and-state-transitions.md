...
The first full gate completed 1,669 unit tests: 1,668 passed and the image-population test failed because new canonical images are missing. It also reported a CSS-density overrun. Reusing public Stack/Cluster composition and the Callout glyph colour for its border reduces the full emitted CSS to 352,641 bytes, below the 352,723-byte ceiling; no limit was changed.
