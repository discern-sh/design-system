...
Canonical images were regenerated with `deno task catalogue:images --update` after integrating the separately owned platform migration from main. The command recaptured the CodeListing and CodeBlock images from the combined authored tree; no image or manifest facts were hand-edited.
