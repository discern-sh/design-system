...
| 2B  | [Polish form alignment and validation](_done/2b-form-alignment-and-validation.md)               | C1, C2, C4             | None            | M    | Complete |
...
| 2F  | [Improve source listing copy and wrapping](_done/2f-code-listing-copy-and-wrap.md)              | F3                     | 1B              | S–M  | Complete |
...
| 2M  | [Make comparison genuinely side by side](_done/2m-side-by-side-comparison.md)                   | L1                     | 1C              | S    | Complete |
...
| 2P  | [Polish terminal previews and guided flows](_done/2p-terminal-capabilities-and-guided-flows.md) | O1, O2, O3, O5         | 1A, 1C          | L    | Complete |
