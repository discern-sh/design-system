...
- `DiagramSpec` is the accessibility/semantics authority. `diagramAltText` derives the raw image alternative, the Markdown title may repeat the summary, and both are checked for agreement; do not create a third free-form description prop.
