...
| 2A  | [Ship the first complete Diagram surface](_done/2a-shipped-diagram-surface.md)                | One integrating agent                                                     | Complete                                                       |
| 3A  | [Project diagrams through Markdown and the terminal reader](_done/3a-markdown-integration.md) | One integrating agent                                                     | Complete                                                       |
| 4A  | [Complete the diagram-kind library](_done/4a-diagram-kind-library.md)                         | One coordinator; up to four disjoint kind sub-agents in the same worktree | Complete                                                       |
| 5A  | [Harden the complete surface for release](_done/5a-production-hardening.md)                   | One adversarial hardening agent; read-only audits may fan out             | Complete                                                       |
