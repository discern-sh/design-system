...
[ADR-0042](../_adr/0042-separate-unicode-glyph-identity-from-curated-aliases.md) records why Unicode identity, contextual meaning, and fallback are separate facts. [ADR-0044](../_adr/0044-publish-curated-glyphs-not-canonical-atlas.md) fixes the future publication boundary: a React-free `./glyphs` entrypoint exposes only approved curated candidates and resolution metadata, while the canonical Atlas remains private and Catalogue-visible. That entrypoint is not implemented yet.
