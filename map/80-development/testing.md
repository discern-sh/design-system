...
| ------------------------------ | ----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `artifact_family_test.tsx`     |     6 | Canonical state arrays enroll future members; neutral-applicable CSS excludes warning and danger tokens through decoded quoted, unquoted, compound, list, and operator selectors; complete WHATWG flow and phrasing populations guard annotations. |
