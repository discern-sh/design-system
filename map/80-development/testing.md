...
| `design_system_test.ts`        |    26 | Folder, token, runtime, and state vocabularies drive class guards; future aliases, future target faces, source-confusable replacements, local shadows, and one-byte mutations prove exact browser enrollment and metric authority.                                                                                 |
