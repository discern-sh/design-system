...
| ------------------------------ | ----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `artifact_family_test.tsx`     |     6 | Canonical state arrays enroll future members; decoded CSS identifiers exclude warning and danger tokens from File change's own sheet, while the generated Component registry enrolls every foreign stylesheet in its selector-ownership boundary; complete WHATWG flow and phrasing populations guard annotations. |
...
| `design_system_test.ts`        |    26 | Folder, token, runtime, and state vocabularies drive class guards; normalized family spellings, malformed descriptor tails, future aliases and target faces, source-confusable replacements, local shadows, and one-byte mutations prove browser enrollment and metric authority.                                  |
