...
| ------------------------------ | ----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `artifact_family_test.tsx`     |     6 | Canonical state arrays enroll future members; neutral-applicable CSS excludes warning and danger tokens; complete WHATWG flow and phrasing populations guard annotations.  |
