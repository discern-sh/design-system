...
| [testing.md](testing.md)                               | Unit and browser-conformance suites, their permissions, generic resilience enrollment, cached-only fixtures, filtering one test, and the suite-audit ledger.                                                             |
...
| [canonical-sets.md](canonical-sets.md)                 | Shared facts, their authorities, the consumers derived from them, and the guard that fails when a representation drifts.                                                                                                 |
| [checkout-convergence.md](checkout-convergence.md)     | Project-specific checkout setup, preview review, final gate, and landing behavior.                                                                                                                                       |
| [design-system-artifact.md](design-system-artifact.md) | Maintainer convenience: the generator behind the Claude Design "Design System" artifact that mirrors this package, what it derives from where, and how a re-sync is published.                                           |
