...
One of the eleven canonical component families — Agents, Core, Display, Docs, Editorial, Feedback, Forms, Layout, Marketing, Navigation, People — mirrored by the folder layout under `src/components/`. A Group is a valid unit of Selection.
