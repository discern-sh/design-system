...
| [15-glyphs/](15-glyphs/)                   | The private Unicode 17.0 Glyph Atlas authority, curated Discern aliases, provenance, validation, and the ownership boundary around existing glyph grammars.                                                              |
| [20-components/](20-components/)           | The 120 Component folders: anatomy, the thirteen Groups, Owned Classes, and the authoring rules.                                                                                                                         |
...
| [60-catalogue/](60-catalogue/)             | The local component browser: the catalogue app, the build pipeline, and the dev server.                                                                                                                                  |
| [70-cli/](70-cli/)                         | The React-free terminal foundation, permanent per-Component stances, complete CLI Catalogue, and optional Component-backed Interactive Adapter.                                                                          |
...
| `_internal/`   | Created the first time a documenter agent grows a subtree — the documenter brief and per-subtree scope manifests for writing and refreshing this tree. Not part of the user-facing docs; kept for reproducibility. |

---

## How the map is produced and kept current

The map is seeded once by `discern setup`, then grown subtree-by-subtree by a documenter agent working from the real code, which materializes its brief at `_internal/documenter-agent-brief.md` on its first run. A single skeleton-and-orientation pass establishes the shared terminology and shape before any subtree is filled in.
